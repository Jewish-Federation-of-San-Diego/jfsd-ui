...
import CashForecastDashboard from './dashboards/CashForecastDashboard';
...
const menuItems = [
  ...
  { key: 'cash-forecast', icon: <DollarOutlined />, label: 'Cash Forecast' },
...
function App() {
  ...
  const renderDashboard = () => {
    switch (selectedKey) {
      ...
      case 'cash-forecast': return <CashForecastDashboard />;
